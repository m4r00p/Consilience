...
var envinfo = {"qx.application":"consilience.Application","qx.revision":"","qx.theme":"consilience.theme.Theme","qx.version":"2.1"};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"script"},"consilience":{"resourceUri":"../source/resource","sourceUri":"../source/class"},"qx":{"resourceUri":"../sdk/framework/source/resource","sourceUri":"../sdk/framework/source/class","sourceViewUri":"https://github.com/qooxdoo/qooxdoo/blob/%{qxGitBranch}/framework/source/class/%{classFilePath}#L%{lineNumber}"}};
